  ...
  template: `
    <div class="min-h-screen flex">
      ...
      <div class="hidden lg:flex lg:w-1/2 relative bg-slate-900 flex-col justify-between p-12 overflow-hidden">
        ...
        <!-- Glows -->
        <div class="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-aprobada/10 rounded-full blur-3xl pointer-events-none"></div>
        <div class="absolute bottom-1/3 right-1/4 w-48 h-48 bg-disponible/5 rounded-full blur-3xl pointer-events-none"></div>

        <div class="relative">
          <div class="w-10 h-10 rounded-xl bg-aprobada/20 border border-aprobada/30 flex items-center justify-center mb-8">
            <svg class="w-5 h-5 text-aprobada" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <circle cx="12" cy="12" r="3"/>
              <path d="M12 2v3M12 19v3M4.22 4.22l2.12 2.12M17.66 17.66l2.12 2.12M2 12h3M19 12h3M4.22 19.78l2.12-2.12M17.66 6.34l2.12-2.12"/>
            </svg>
          </div>
          <h1 class="font-display text-4xl text-white mb-4 leading-tight">
            Motor de<br/>Inferencia<br/>Académica
          </h1>
          <p class="text-slate-400 text-base leading-relaxed max-w-xs">
            Visualiza tu progreso en la malla curricular de Estadística como un grafo de dependencias en tiempo real.
          </p>
        </div>
        ...
        <div class="relative">
          ...
          <div class="flex items-center gap-4 mt-6 text-xs text-slate-500">
            <span class="flex items-center gap-1.5"><span class="w-2 h-2 rounded-full bg-aprobada"></span>Aprobadas</span>
            <span class="flex items-center gap-1.5"><span class="w-2 h-2 rounded-full bg-disponible"></span>Disponibles</span>
            <span class="flex items-center gap-1.5"><span class="w-2 h-2 rounded-full bg-slate-600"></span>Bloqueadas</span>
          </div>
        </div>
      </div>
      ...
      <div class="flex-1 flex items-center justify-center p-6 lg:p-12">
        <div class="w-full max-w-sm">
          ...
          <p class="text-center text-sm text-slate-500 mt-6">
            ¿No tienes cuenta?
            <a routerLink="/registro" class="text-aprobada hover:text-aprobada/80 transition-colors ml-1">
              Regístrate
            </a>
          </p>
        </div>
